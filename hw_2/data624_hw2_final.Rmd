...
```
To get additional experience, we will try to do some work using python. The library `retriculate` helps with passing variables between r and python.
...
Now lets recreate a list of missing variables to understand where the NAs are.
