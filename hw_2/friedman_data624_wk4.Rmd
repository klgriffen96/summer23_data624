...
dfr[1,] = data.frame(
    ...
    Train.RMSE=enet_fit$results[['RMSE']],
...
It's very challenging to understand the relative importance of predictors in a methodology that chooses predictors based n performance, especially when many features are highly correlated. 

(See, for examplem (https://stats.stackexchange.com/questions/403303/how-to-interpret-metric-lasso-regression-coefficients)[https://stats.stackexchange.com/questions/403303/how-to-interpret-metric-lasso-regression-coefficients])
